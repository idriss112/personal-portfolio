...
const SkillItem = ({ skill }: { skill: string }) => {
  ...
  return (
    <div className="mx-4 my-4 group">
      <div className="relative px-8 py-6 rounded-2xl border border-white/5 bg-white/[0.02] backdrop-blur-3xl transition-all duration-500 hover:border-[#61DAFB]/30 hover:bg-white/[0.05] flex items-center gap-4 shadow-xl">
        <div
        ...
        <div className="flex flex-col">
          <span className="text-sm font-bold text-white tracking-wide uppercase group-hover:text-[#61DAFB] transition-colors">
            {skill}
          </span>
...
function Skills() {
  ...
  return (
    <div id="skills" className="relative z-50 py-16 lg:py-24 overflow-hidden ">
      ...
      <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#21232A]/10 blur-[120px] rounded-full pointer-events-none" />
          ...
          <SectionReveal direction="down">
            <div className="flex flex-col items-center gap-4">
              <div className="flex items-center gap-3 text-[#61DAFB]">
                <span className="w-8 h-[1px] bg-[#61DAFB]/50"></span>
