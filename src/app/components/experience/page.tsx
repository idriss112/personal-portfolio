  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-4 relative">
        ...
        <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 top-0 bottom-0 w-[2px] bg-gradient-to-b from-[#61DAFB] via-[#21232A] to-transparent opacity-30" />
              ...
              <SectionReveal direction={index % 2 === 0 ? "right" : "left"}>
                ...
                >
                  ...
                  <div className="absolute left-4 md:left-1/2 md:-translate-x-1/2 top-0 w-10 h-10 rounded-xl bg-[#050505] border-2 border-[#61DAFB] flex items-center justify-center z-10 shadow-[0_0_15px_rgba(97, 218, 251, 0.3)]">
                    <BsPersonWorkspace className="text-[#61DAFB] w-5 h-5" />
                  </div>
                    ...
                    <div className="group relative p-8 rounded-3xl border border-white/10 bg-white/[0.02] backdrop-blur-md hover:border-[#61DAFB]/50 transition-all duration-500 shadow-xl hover:shadow-[#61DAFB]/10">
                      <div className="flex flex-col gap-4">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="flex items-center gap-2 text-[#61DAFB] font-semibold">
                        ...
                        <div className="space-y-3 mt-2">
                          {exp.details?.map((detail, idx) => (
                            ...
                            >
                              <ChevronRight className="w-4 h-4 text-[#61DAFB] mt-1 shrink-0 group-hover/item:translate-x-1 transition-transform" />
                      ...
                      <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-[#61DAFB]/20 via-transparent to-[#20232A]/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                    </div>
                  </div>
                </div>
              </SectionReveal>
