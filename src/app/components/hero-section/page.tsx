...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-20 left-10 w-72 h-72 bg-[#61DAFB]/10 blur-[120px] rounded-full animate-pulse" />
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-[#20232A]/10 blur-[150px] rounded-full animate-pulse delay-700" />
        ...
        <div className="order-2 lg:order-1 flex flex-col items-start gap-8">
          <div className="flex flex-col gap-4">
            ...
            <p className="hero-heading text-lg md:text-xl text-slate-400 max-w-xl leading-relaxed font-medium">
              ...
              a professional
              <span
                className="text-[#61DAFB] ml-2 font-bold inline-block min-w-[200px]"
                ref={designationRef}
              >
          ...
          <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
              <Link
                ...
                target="_blank"
                className="social-icon p-3 rounded-xl bg-white/5 border border-white/10 text-white hover:text-[#61DAFB] hover:border-[#61DAFB]/50 transition-all duration-300 shadow-xl"
              >
                <BsGithub size={24} />
              </Link>
              <Link
            ...
            <div className="hero-cta flex flex-wrap gap-4">
              <Link
                href="/#contact"
                className="group relative px-8 py-4 rounded-2xl bg-gradient-to-r from-[#61DAFB] to-[#20232A] text-white font-bold uppercase tracking-wider overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(97, 218, 251, 0.3)]"
              >
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-white/5 bg-white/5">
                <div className="flex gap-2">
                  ...
                  <div className="w-3 h-3 rounded-full bg-[#88E5FF]/50" />
                  <div className="w-3 h-3 rounded-full bg-[#88E5FF]/20" />
                </div>
              ...
              <div className="p-6 lg:p-10">
                <code className="font-mono text-xs md:text-sm lg:text-base leading-relaxed">
                  <div className="flex gap-4">
                    ...
                    <p>
                      <span className="text-[#61DAFB]">const</span>{" "}
                  ...
                  <div className="flex gap-4">
                    ...
                    <p className="ml-4">
                      ...
                      <span className="text-[#61DAFB]">true</span>,
                    </p>
                  </div>
                  <div className="flex gap-4">
                  ...
                  <div className="flex gap-4 mt-4">
                    ...
                    <p>
                      <span className="text-[#61DAFB]">developer</span>.
