      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="flex flex-col items-center gap-12 lg:gap-20">
          <div className="text-center">
            <p className="text-[#61DAFB] text-sm font-bold uppercase tracking-[0.4em] mb-4">
              Portfolio
            </p>
          ...
          <Link href="/projects" className="group mt-8">
            <button className="relative px-10 py-4 rounded-2xl bg-gradient-to-r from-[#61DAFB] to-[#20232A] text-white font-bold uppercase tracking-widest text-sm transition-all hover:scale-105 active:scale-95 shadow-[0_0_30px_rgba(97, 218, 251, 0.3)] flex items-center gap-2 overflow-hidden">
