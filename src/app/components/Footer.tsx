            ...
            {[
              ...
              <li key={item.to}>
                <ScrollLink
                  ...
                  smooth
                  duration={500}
                  className="text-gray-400 hover:text-[#61DAFB] transition-all cursor-pointer font-medium"
                >
                  {item.label}
                </ScrollLink>
              </li>
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex space-x-4">
            <Link
              ...
              target="_blank"
              className="p-2 rounded-lg bg-white/5 hover:bg-[#61DAFB]/10 hover:text-[#61DAFB] transition-all border border-white/5"
            >
              <FaGithub size={20} />
            </Link>
            <Link
