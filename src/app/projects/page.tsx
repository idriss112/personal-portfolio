...
const ProjectsPage = () => {
  return (
    <section id="projects" className="relative min-h-screen  overflow-hidden">
      ...
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-[#61DAFB]/10 blur-[120px] rounded-full pointer-events-none" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#20232A]/10 blur-[120px] rounded-full pointer-events-none" />
